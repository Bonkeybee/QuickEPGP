...
QUICKEPGP.DefaultConfig = function(QUICKEPGP_OPTIONS)
  ...
  QUICKEPGP_OPTIONS.MasterFrame.Width = default(QUICKEPGP_OPTIONS.MasterFrame.Width, 300)
  QUICKEPGP_OPTIONS.MasterFrame.Height = default(QUICKEPGP_OPTIONS.MasterFrame.Height, 150)
